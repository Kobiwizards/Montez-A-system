...
exports.config = {
    ...
    // File uploads
    uploadPath: process.env.UPLOAD_PATH || path_1.default.join(process.cwd(), 'uploads'),
    receiptsPath: process.env.RECEIPTS_PATH || path_1.default.join(process.cwd(), 'receipts'),
