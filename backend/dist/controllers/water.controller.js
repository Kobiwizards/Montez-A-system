...
class WaterController {
    constructor() {
        this.getAllReadings = async (req, res) => {
            try {
        ...
        this.getReadingById = async (req, res) => {
            try {
                const { id } = req.params;
        ...
        this.createReading = async (req, res) => {
            try {
        ...
        this.updateReading = async (req, res) => {
            try {
                if (!req.user || req.user.role !== 'ADMIN') {
                    return res.status(403).json({
                        success: false,
        ...
        this.getTenantReadings = async (req, res) => {
            try {
                if (!req.user) {
        ...
        this.calculateWaterBill = async (req, res) => {
            try {
