...
class AnalyticsController {
    ...
    getDashboardMetrics = async (_, res) => {
        try {
    ...
    getOccupancyReport = async (_, res) => {
        try {
    ...
    getWaterConsumptionReport = async (req, res) => {
        try {
        ...
        try {
            ...
            switch (type) {
                ...
                case 'occupancy':
                    ...
                    const currentOccupants = await prisma_1.prisma.user.findMany({
                        where: {
                            role: 'TENANT',
                            status: { in: ['CURRENT', 'OVERDUE', 'DELINQUENT'] }
                        }
                ...
                case 'payments':
                    ...
                    const allPayments = await prisma_1.prisma.payment.findMany({
                        where: {
                            createdAt: {
                                gte: start,
                                lte: end
